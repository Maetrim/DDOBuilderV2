...
class EffectCallbackItem
{
    public:
        ...
        virtual void StanceActivated(Build* charData, const std::string& stanceName) = 0;
        virtual void StanceDeactivated(Build* charData, const std::string& stanceName) = 0;
        virtual void SliderChanged(Build* charData, const std::string& sliderName, int newValue) = 0;
        virtual void GearChanged(Build* charData, InventorySlotType slot) = 0;
};
