...
const XmlLib::enumMapEntry<ClassSaveType> classSaveTypeMap[] =
{
    {SaveType_Unknown,  L"Unknown"},
    {SaveType_None,     L"None"},
    {SaveType_Type1,    L"Type1"},
    {SaveType_Type2,    L"Type2"},
    {ClassSaveType(0), NULL}
};
