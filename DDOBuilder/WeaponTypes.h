...
const XmlLib::enumMapEntry<WeaponType> weaponTypeMap[] =
{
    ...
    {Weapon_CosmeticShield, L"Cosmetic Shield"},
    ...
    {Weapon_DwarvenAxe, L"Dwarven War Axe"},
    {Weapon_DwarvenAxe, L"Dwarven Waraxe"},
    {Weapon_GreatAxe, L"Greataxe"},
    {Weapon_GreatClub, L"Greatclub"},
    {Weapon_GreatSword, L"Greatsword"},
    {Weapon_HandAxe, L"Handaxe"},
    {Weapon_Handwraps, L"Handwrap"},
    {Weapon_Longbow, L"Long Bow"},
    {Weapon_Shortbow, L"Short Bow"},
