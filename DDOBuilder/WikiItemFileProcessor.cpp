...
void WikiItemFileProcessor::Start()
{
    ...
    pFrameWnd->BeginProgress("Processing wiki files...");
    ...
    if (hFind != INVALID_HANDLE_VALUE)
    {
        ...
        ProcessFile(fileIndex++, fullFilename);
        while (FindNextFile(hFind, &findFileData))
        {
            ...
            int percent = static_cast<int>(fileIndex * 100 / totalFileCount);
    ...
    text.Format("Processing complete, %d files done", totalFileCount);
    GetLog().AddLogEntry(text);
}
...
void WikiItemFileProcessor::ProcessSpecificFile()
{
    ...
    if (dlg.DoModal() == IDOK)
    {
        ...
        ProcessFile(0, (LPCTSTR)filename);
    }
}
...
void WikiItemFileProcessor::ProcessFile(int fileIndex, const std::string& filename)
{
    ...
    if (file.Open(filename.c_str(), CFile::modeRead))
    {
        ...
        bool bMinorArtefact = fileContent.find("Minor artifacts") != std::string::npos
                    || fileContent.find("Minor Artifacts") != std::string::npos;
        ...
        const std::string& fileData)
{
    ...
    {
        enchantmentsText = ExtractSingleField(">Enhancements", "#AACCFF\">Enhancements", "</td>", fileData);
        if (!enchantmentsText.empty())
        {
            itemFields["Enchantments"] = enchantmentsText;
        }
...
bool WikiItemFileProcessor::ProcessEnchantmentLine(const std::string& line)
{
    ...
    if (m_item.HasWeapon() && IsShield(m_item.Weapon()))
    {
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "OrbBonus", "While this orb is equipped and you are actively blocking", "Orb", "", 60);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Turning", "Greater Turning Greater Turning", "Equipment", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Energy Siphon IV", "Energy Siphon IV", "Equipment", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Energy Siphon VI", "Energy Siphon VI", "Equipment", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Energy Siphon V", "Energy Siphon V", "Equipment", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Energy Siphon XII", "Energy Siphon XII", "Equipment", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Energy Siphon XI", "Energy Siphon XI", "Equipment", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Energy Siphon X", "Energy Siphon X", "Equipment", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "The Golden Curse", "The Golden Curse The Golden Curse", "Equipment", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "True Law", "True Law True Law", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Absolute Law", "Absolute Law Absolute Law", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Supreme Law", "Supreme Law Supreme Law", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Pure Good", "Pure Good Pure Good", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Shadow Spike", "Shadow Spike Shadow Spike", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Acid Burst", "Acid Burst Acid Burst", "Equipment", "", 5);

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Feeding 10", "Feeding 10 Feeding 10", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Feeding 20", "Feeding 20 Feeding 20", "Equipment", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Feeding 30", "Feeding 30 Feeding 30", "Equipment", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Cursed Maelstrom", "Cursed Maelstrom", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Brazen Brilliance", "Brazen Brilliance Brazen Brilliance", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Banishing", "Banishing Banishing", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sovereign Banishing", "Sovereign Banishing Sovereign Banishing", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Fleshmaker", "Fleshmaker Fleshmaker", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Stench", "Stench Stench", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "SmokeScreen", "Smoke Screen", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "PoisonGuard", "Poison Guard Poison Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Nullmagic Guard", "Nullmagic Guard", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Stone Guard", "Legendary Stone Guard", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Disruption Guard", "Greater Disruption Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Magma Surge Guard", "Legendary Magma Surge Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Boon of Undeath", "Greater Boon of Undeath", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Lingering Acidic Burn", "Lingering Acidic Burn", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Acid Torrent", "Legendary Acid Torrent", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Lightning Lash", "Lightning Lash", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bitter Frostbite", "Bitter Frostbite", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Rupturing Echo", "Rupturing Echo", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Rippling Energy", "Rippling Energy", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Telekinetic45", "Telekinetic 45 Telekinetic", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Telekinetic117", "Telekinetic 117 Telekinetic", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Telekinetic", "Telekinetic Telekinetic", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Staggering45", "Staggering 45 Staggering", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Staggering117", "Staggering 117 Staggering", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sunburst45", "Sunburst 45 Sunburst", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sunburst117", "Sunburst 117 Sunburst", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "WildFrenzy50", "Wild Frenzy +50", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "WildFrenzy122", "Wild Frenzy +122", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "WindFrenzy50", "Wind Frenzy +50", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "WindFrenzy122", "Wind Frenzy +122", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sirocco50", "Sirocco +50", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sirocco122", "Sirocco +122", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Arcane Casting Dexterity", "Greater Arcane Casting Dexterity", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Profane Well Rounded", "Profane Well Rounded", "Profane", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Stone Prison", "Greater Stone Prison", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Inspiring Echoes", "Inspiring Echoes", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "FireAndColdAbsorption", "Fire and Cold Absorption", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "ElectricityAndAcidAbsorption", "Electricity and Acid Absorption", "", "", 5);

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Virulent Poison", "Legendary Virulent Poison", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Trap the Soul", "Legendary Trap the Soul", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Cursespewing", "Legendary Cursespewing", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Brilliance Guard", "Legendary Brilliance Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Lightningstorm Guard", "Legendary Lightningstorm Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Lightning Storm Guard", "Lightning Storm Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Freezing Ice Guard", "Freezing Ice Guard Freezing Ice Guard", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Freezing Gale", "Legendary Freezing Gale", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Freezing Ice", "Legendary Freezing Ice", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "DR 5/Piercing", "DR Damage Reduction 5/Piercing", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "DR 10/Piercing", "DR Damage Reduction 10/Piercing", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "DR 15/Piercing", "DR Damage Reduction 15/Piercing", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Fearsome", "Fearsome Fearsome", "", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Distant Incite", "Distant Incite", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Mystic Incite", "Insightful Mystic Incite", "Insightful", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Mystic Incite", "Mystic Incite", "Enhancement", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sinister Chill", "Sinister Chill Sinister Chill", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sight Beyond Sight", "Sight Beyond Sight", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Thorn of the Rose", "Thorn of the Rose", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "EfficientEmpowerI", "Efficient Metamagic - Empower I", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "EfficientEnlargeII", "Efficient Metamagic - Enlarge II", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "EfficientEnlargeI", "Efficient Metamagic - Enlarge I", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "EfficientQuickenII", "Efficient Metamagic - Quicken II", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "EfficientQuickenI", "Efficient Metamagic - Quicken I", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "GreaterAutoRepair", "Greater Auto-Repair ", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Spikes", "Spikes Spikes", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Venomscale", "Venomscale", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Silver Flame", "Silver Flame Silver Flame", "Equipment", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic III", "Axiomatic III", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic II", "Axiomatic II", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic I", "Axiomatic I", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic Blast 2", "Axiomatic Blast 2", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic Blast 3", "Axiomatic Blast 3", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic Blast 4", "Axiomatic Blast 4", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic Blast 5", "Axiomatic Blast 5", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Axiomatic Blast 6", "Axiomatic Blast 6", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "EvilOutsiderBane 7", "Evil Outsider Bane 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "LawfulOutsiderBane 3", "Lawful Outsider Bane 3", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "LawfulOutsiderBane 7", "Lawful Outsider Bane 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Fiery 7", "Fiery 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Holy 7", "Holy 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Shocking Blast 7", "Shocking Blast 7", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Coruscating7", "Coruscating 7", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Incandescence", "Incandescence Incandescence", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Impactful7", "Impactful 7", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Electrifying7", "Electrifying 7", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Anarchic Blast 7", "Anarchic Blast 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Anarchic Burst 3", "Anarchic Burst 3 Anarchic Burst 3", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Anarchic Burst 7", "Anarchic Burst 7 Anarchic Burst 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Anarchic 7", "Anarchic 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Reverberating 7", "Reverberating 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Screeching 7", "Screeching 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Screeching 8", "Screeching 8", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Screeching 9", "Screeching 9", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Screeching 16", "Screeching 16", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Dragon's Edge 2", "Dragon's Edge 2 Dragon's Edge 2", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Dragon's Edge 3", "Dragon's Edge 3 Dragon's Edge 3", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Dragon's Edge 7", "Dragon's Edge 7 Dragon's Edge 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Jolting 7", "Jolting 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Jolting 8", "Jolting 8", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Jolting 16", "Jolting 16", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Icy Blast 7", "Icy Blast 7", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Icy Blast 8", "Icy Blast 8", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Holy Burst 2", "Holy Burst 2", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Holy Burst 7", "Holy Burst 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Holy Burst 8", "Holy Burst 8", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Overwhelming Incineration", "Overwhelming Incineration", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Blinding Embers", "Legendary Blinding Embers", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Good", "Greater Good Greater Good", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Force Blast 7", "Force Blast 7", "", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Unholy 7", "Unholy 7", "", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Unholy 8", "Unholy 8", "", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Freezing 16", "Freezing 16", "", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Burning Glory 1", "Burning Glory 1", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Burning Glory 6", "Burning Glory 6", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Notable Target", "Notable Target", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Lesser Aberration Bane", "Lesser Aberration Bane", "", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Aberration Bane 6", "Aberration Bane 6", "", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Aberration Bane", "Aberration Bane", "", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Magical Beast Bane", "Greater Magical Beast Bane", "", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Magical Beast Bane", "Magical Beast Bane", "", "All");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Stability", "Stability Stability", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Superior Stability", "Superior Stability", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Unwieldy", "Unwieldy Unwieldy", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Rock Shattering", "Rock Shattering Rock Shattering", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Psychic Ward", "Psychic Ward Psychic Ward", "Enhancement", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Legendary Stealer of Souls", "Legendary Stealer of Souls Legendary Stealer of Souls", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Lesser Boneshatter", "Lesser Boneshatter Lesser Boneshatter", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Shadowblade", "Shadowblade Shadowblade", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Constricting Nightmare", "Constricting Nightmare Constricting Nightmare", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Eversight", "Eversight Eversight", "", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Gashing 15", "Gashing 15", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Gashing 16", "Gashing 16", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Slashing 7", "Slashing 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Smashing 16", "Smashing 16", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Blazing 16", "Blazing 16", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Piercing 7", "Piercing 7", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Chilling 7", "Chilling 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Chilling 8", "Chilling 8", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Crushing16", "Crushing 16", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Maiming7", "Maiming 7", "Enhancement", "All");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Maiming8", "Maiming 8", "Enhancement", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Equipoised Focus", "Equipoised Focus", "", "All");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Flaming 6", "Flaming 6 Flaming 6", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Flaming 7", "Flaming 7 Flaming 7", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Flaming 16", "Flaming 16 Flaming 16", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Solar Guard VIII", "Solar Guard VIII", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Solar Guard VII", "Solar Guard VII", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Solar Guard VI", "Solar Guard VI", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Solar Guard V", "Solar Guard V", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Solar Guard IV", "Solar Guard IV", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Solar Guard III", "Solar Guard III", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Entropic 7", "Entropic 7", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "ProficiencyLongsword", "Proficiency: Longsword", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "FeatElusiveTarget", "Feat : Elusive Target Feat", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "FeatFirstBlood", "Feat : First Blood Feat", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Raging Inferno", "Raging Inferno", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "MagmaSurge2", "Magma Surge 2 Magma Surge 2", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "MagmaSurge7", "Magma Surge 7 Magma Surge 7", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Marksmanship", "Greater Marksmanship Greater Marksmanship", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Marksmanship", "Marksmanship Marksmanship", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Soundproof", "Soundproof Soundproof", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Sounding", "Sounding Sounding", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Grip of Venom", "Grip of Venom", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Disintegrate 2", "Disintegrate 2", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Disintegrate 7", "Disintegrate 7", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Unstoppable Staggering Blow", "Unstoppable Staggering Blow", "", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Echoes of Angdrelve 3", "Echoes of Angdrelve 3", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Echoes of Angdrelve 7", "Echoes of Angdrelve 7", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Penalty Good", "Penalty: If equipped by a Good user, they receive 1 Negative Level", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Penalty Evil", "Penalty: If equipped by a Evil user, they receive 1 Negative Level", "", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Ethereal", "Ethereal Ethereal", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Heroism", "Greater Heroism Greater Heroism: Passive", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Hardened Exterior", "Hardened Exterior", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Don't Count Me Out!", "Don't Count Me Out!", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Heroic Inspiration", "Heroic Inspiration", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Greater Elemental Spell Power", "Greater Elemental Spell Power", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Elemental Spell Power", "Elemental Spell Power", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Elemental Absorption", "Elemental Absorption", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Alignment Absorption", "Alignment Absorption", "", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Quality Shield", "Quality Shield", "", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Vulnerability Guard", "Vulnerability Guard Vulnerability Guard", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Guardbreaking", "Guardbreaking Guardbreaking", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Melodic Guard", "Melodic Guard Melodic Guard", "Enhancement", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Improved Bashing", "Improved Bashing Improved Bashing", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing", "Bashing Bashing", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing 2", "Bashing 2", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing 3", "Bashing 3", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing 4", "Bashing 4", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing 5", "Bashing 5", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing 6", "Bashing 6", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing 7", "Bashing 7", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Bashing IV", "Bashing IV", "Enhancement", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Toxic 6", "Toxic 6 Toxic 6", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Toxic 7", "Toxic 7 Toxic 7", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Toxic 16", "Toxic 16 Toxic 16", "Enhancement", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Corroding 7", "Corroding 7 Corroding 7", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Corroding 16", "Corroding 16 Corroding 16", "Enhancement", "");

    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Dazing IV", "Dazing IV", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Dazing VII", "Dazing VII", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Touched by Wild Magic", "Touched by Wild Magic", "Enhancement", "");
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Wrath of the Zealot", "Wrath of the Zealot", "Enhancement", "");
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Spearblock VII", "Spearblock VII", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Hammerblock IV", "Hammerblock IV", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Hammerblock VII", "Hammerblock VII", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Illusion Save", "Illusion Save", "", "", 5);
    if (!bRecognised) bRecognised |= AddCommonEffect(line, "Major Anger", "Major Anger Major Anger", "", "", 5);
    ...
    if (!bRecognised) bRecognised |= line.find("On Vorpal Hit : If an outsider struck by this weapon") != std::string::npos;
    if (!bRecognised) bRecognised |= line.find("and/or") != std::string::npos;
...
bool WikiItemFileProcessor::AddAugmentSlots(const std::string& line)
{
    ...
    if (m_item.MinLevel() > MAX_CLASS_LEVEL)
    {
        ...
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Ability Score", "Nearly Complete: Ability Score (Legendary)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Insightful Ability Score", "Nearly Complete: Insightful Ability Score (Legendary)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Quality Ability", "Nearly Complete: Quality Ability Score (Legendary)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Healing Amplification", "Nearly Complete: Healing Amplification (Legendary)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Skill", "Nearly Complete: Exceptional Skills (Legendary)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Spell Focus", "Nearly Complete: Spell Focus (Legendary)", "");
    }
    else
    {
        bRecognised |= AddAugmentSlot(line, "Lamordia: Melancholic Slot (Armor)", "Melancholic Slot (Armor) ", "");
        ...
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Ability Score", "Nearly Complete: Ability Score (Heroic)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Insightful Ability Score", "Nearly Complete: Insightful Ability Score (Heroic)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Quality Ability", "Nearly Complete: Quality Ability Score (Heroic)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Healing Amplification", "Nearly Complete: Healing Amplification (Heroic)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Skill", "Nearly Complete: Exceptional Skills (Heroic)", "");
        bRecognised |= AddAugmentSlot(line, "Nearly Complete: Spell Focus", "Nearly Complete: Spell Focus (Heroic)", "");
    }
...
bool WikiItemFileProcessor::ProcessBonusType(const std::string& line, const std::string& bonus)
{
    ...
    if (!bProcessed) bProcessed = ProcessIntensity(line, bonus);
    ...
    if (!bProcessed) bProcessed = ProcessCarryingCapacity(line, bonus);
...
bool WikiItemFileProcessor::ProcessIntensity(const std::string& line, const std::string& bonus)
{
    bool bProcessed = false;
    // spell power effects
    static std::string spellPowers[] =
    ...
    for (size_t spi = 0; spi < spellPowerCount && !bProcessed; ++spi)
    {
        buffName.Format("%sIntensity", spellPowers[spi].c_str());
        if (bonus != "Equipment")
        {
            searchText.Format("%s %s Intensity", bonus.c_str(), spellPowers[spi].c_str());
            bProcessed = AddCommonEffect(line, (LPCTSTR)buffName, (LPCSTR)searchText, bonus, "");
        }
        else
        {
            searchText.Format("%s Intensity", spellPowers[spi].c_str());
            bProcessed = AddCommonEffect(line, (LPCTSTR)buffName, (LPCSTR)searchText, bonus, "");
        }
    }
    return bProcessed;
...
bool WikiItemFileProcessor::ProcessCarryingCapacity(
    const std::string& line,
    const std::string& bonus)
{
    ...
    if (bonus != "Enhancement")
    {
        searchText.Format("%s Carrying Capacity", bonus.c_str());
        bProcessed = AddCommonEffect(line, "Carrying Capacity", (LPCSTR)searchText, bonus, "");
    }
    else
    {
        bProcessed = AddCommonEffect(line, "Carrying Capacity", "Carrying Capacity", bonus, "");
    }
    return bProcessed;
}
